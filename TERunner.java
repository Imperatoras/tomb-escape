/*
 ...
 public class TERunner
 {
     ...
     public static void main(String[] args)
     {
         ...
         System.out.println("Yet the second you do, a great flash of red light causes you to cover your eyes. The sandstone floor rumbles beneath your feet. And suddenly, the tomb\'s hieroglyphs begin to glow a bright red.");
         ...
         System.out.println("It\'s clear now that you\'re in dire straits. If you don\'t escape from this tomb, and fast, you\'ll be joining the mummies!");
